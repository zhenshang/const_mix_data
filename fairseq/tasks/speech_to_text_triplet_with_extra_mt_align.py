...
from fairseq.data.audio.speech_text_align_triple_dataset import (
    SpeechTextAlignTripleDataset,
    SpeechTextAlignTripleDatasetCreator
)
...
@register_task("speech_to_text_triplet_with_extra_mt_align")
class SpeechToTextTripletWithExtraMTTaskAlign(LegacyFairseqTask):
    @staticmethod
    def add_args(parser):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        st_dataset = SpeechTextAlignTripleDatasetCreator.from_tsv(
            self.args.data,
            self.data_cfg,
            split,
            self.tgt_dict,
    ...
    def get_batch_iterator(
        ...
        if not isinstance(dataset, MultiModalityDataset):
            return super(SpeechToTextTripletWithExtraMTTaskAlign, self).get_batch_iterator(
                dataset,
                max_tokens,
                max_sentences,
                max_positions,
    ...
    def build_model(self, args):
        ...
        model = super(SpeechToTextTripletWithExtraMTTaskAlign, self).build_model(args)
    ...
    def build_generator(
        ...
        lang_token_ids = {
            ...
            if SpeechTextAlignTripleDataset.is_lang_tag(s)
        }
