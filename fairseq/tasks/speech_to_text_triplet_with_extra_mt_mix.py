...
@register_task("speech_to_text_triplet_with_extra_mt_mix")
class SpeechToTextTripletWithExtraMTTaskMix(LegacyFairseqTask):
    @staticmethod
    def add_args(parser):
        ...
        parser.add_argument('--mix-rate', type=float, metavar="N",
                            help="mix_audio_rate")
        parser.add_argument('--word-dict-path',  type=str, default=None,
                            help="word_dict.tsv path (absolute path)")
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        st_dataset = SpeechTextMixTripleDatasetCreator.from_tsv(
            self.args.data,
            self.data_cfg,
            split,
            self.tgt_dict,
            ...
            word_dict_path=self.word_dict_path,
        )
        text_dataset = None
    ...
    def get_batch_iterator(
        ...
        if not isinstance(dataset, MultiModalityDataset):
            return super(SpeechToTextTripletWithExtraMTTaskMix, self).get_batch_iterator(
                dataset,
                max_tokens,
                max_sentences,
                max_positions,
    ...
    def build_model(self, args):
        ...
        model = super(SpeechToTextTripletWithExtraMTTaskMix, self).build_model(args)
    ...
    def build_generator(
        ...
        lang_token_ids = {
            ...
            if SpeechTextMixTripleDataset.is_lang_tag(s)
        }
